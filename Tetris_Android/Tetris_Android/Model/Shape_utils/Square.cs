...
namespace Tetris_Android.Shape_utils
{
    class Square : Shape
    {
        public Square(Coord coord, Coord bound, int colorCode) : base(bound, colorCode)
        {
        }
